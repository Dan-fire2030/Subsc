...
## 完了済み
- [x] レポートカードの横スワイプを慣性スライドにした（2026-07-31）
  - [x] ページ窓を前後60期間へ拡張し、スワイプ完了時の再センタリングを廃止
  - [x] `.viewAligned(limitBehavior: .never)` で1ページ制限を解除
  - [x] スクロール位置を `ReportPager` 内へ閉じ込め、慣性の中断を解消
  - [x] シミュレーターで慣性・吸着・今月へ戻る・1ステップ送り・期間切替を目視確認
